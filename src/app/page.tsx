...
import { ArrowRight, Shield, Cpu, HelpCircle, Activity } from "lucide-react";
    ...
    <div className="flex flex-col items-center min-h-screen" ref={container}>
      ...
      <section className="relative w-full flex flex-col items-center justify-center pt-40 pb-32 px-[var(--spacing-page)] overflow-hidden">
        ...
        >
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-accent/20 to-purple-500/20 rounded-full blur-xl opacity-50 group-hover:opacity-100 transition-opacity duration-500"></div>
      ...
      <section className="how-it-works-section w-full relative z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none opacity-20 flex items-center justify-center">
          <div className="floating-orb w-96 h-96 bg-accent rounded-full blur-[100px] absolute -top-20 -left-20"></div>
          <div className="floating-orb w-[500px] h-[500px] bg-purple-600 rounded-full blur-[120px] absolute top-40 right-10"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-[var(--spacing-page)] py-32 border-t border-white/5 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={item.step}
                className="step-card premium-card p-10 relative overflow-hidden group"
              >
